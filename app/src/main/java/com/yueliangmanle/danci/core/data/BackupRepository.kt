...
class BackupRepository(
    ...
    private suspend fun applySettings(settings: AppSettings) {
        ...
        settingsRepository.updateDefaultCloudTtsProviderId(settings.defaultCloudTtsProviderId)
        settingsRepository.updateDefaultCloudTtsPresetId(settings.defaultCloudTtsPresetId)
        settingsRepository.updateCloudTtsBaseUrl(settings.cloudTtsBaseUrl)
        settingsRepository.updateCloudTtsModel(settings.cloudTtsModel)
