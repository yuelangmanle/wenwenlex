...
internal fun AppSettings.toJson(): JSONObject =
    JSONObject()
        ...
        .put("default_cloud_tts_provider_id", defaultCloudTtsProviderId)
        .put("default_cloud_tts_preset_id", defaultCloudTtsPresetId)
        .put("cloud_tts_base_url", cloudTtsBaseUrl)
        .put("cloud_tts_model", cloudTtsModel)
...
internal fun LearningRecordEntity.toJson(): JSONObject =
    JSONObject()
        ...
        .put("learning_stage", learningStage)
        .put("introduced_at", introducedAt.toBackupString())
        ...
        .put("last_fuzzy_at", lastFuzzyAt.toBackupString())
        .put("last_study_mode", lastStudyMode)
        .put("current_group_pass_state", currentGroupPassState)
...
internal fun StudySessionEntity.toJson(): JSONObject =
    JSONObject()
        ...
        .put("current_group_index", currentGroupIndex)
