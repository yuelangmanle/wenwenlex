...
- 当前已落仓：
  ...
  - 升级安全检查、诊断中心与诊断包导出已落地
  - `validate_release_baseline.sh` 与工作流发版护栏已落地
  - 云端 `Android CI #23400597350`、`Android CI #23401041819` 与 `Android CI #23401721564` 已通过
...
- 当前已落仓：
  ...
  - 云端 `Android CI #23422515288` 已通过
  - 云端 `Android Release #23422780718` 已通过，并已发布 `v1.8`
...
6. 如涉及词库、导入或 AI 路由，再看 `v1.1` 规格；如涉及发音与朗读，先看 `v1.2` 规格，再看 `v1.3` 与 `v1.4` 两轮离线发音规格、实施计划和 smoke 记录
