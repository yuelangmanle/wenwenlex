...
- 最后更新日期：`2026-03-20`
- 当前正式版本：`1.2`
- 当前总体状态：`v1.2 已发布；v1.3 离线单词真实发音核心链路已在开发分支验证通过`
...
| 发音与朗读 v1.3 | 开发中（核心链路已打通） | 已完成 native metadata 合并、Sherpa ONNX runtime 脚手架、本地生成缓存、原生离线单词合成、安装校验和设置页错误可见化，待正式发版 |
...
- native 离线语音包的正式发布、模型资产分发和最终体验调优
- 更丰富的在线词典音频源与缓存命中策略
