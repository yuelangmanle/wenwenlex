...
- 当前正式版本：`1.3`
- 当前开发主线：`1.9`
- 当前总体状态：`v1.3 已发布；v1.9 学习流与音频基础设施主链路已落库，当前进入文档收口、全量回归与正式发版准备阶段`
...
| 学习流与音频基础设施 v1.9 | 开发中（主功能已完成） | 已完成真实学习队列、缓存管理、音频任务中心、云端 TTS 接入、语音包断点续传 / 取消 / 镜像切换，待更新日志收口与正式发版 |
...
- 当前 `1.9` 开发主线已完成学习流和音频基础设施的核心实现，尚未正式发版
...
- `1.9` 收口：更新日志、README、进度书、全量单测和正式 Release 发版
...
- 当前剩余工作集中在更新日志收口、全量回归验证和正式 Release 发版
