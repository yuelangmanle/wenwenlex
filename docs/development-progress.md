...
- 当前正式版本：`1.9`
- 下一阶段主线：`2.0`
- 当前总体状态：`v1.9 已完成正式收口，学习流与音频基础设施已进入可正式发版状态；下一步转向真实离线模型语音包与发音体验增强`

## 2. 当前版本快照

- 项目名称：`文文Lex`
- 发布页面：[GitHub Releases](https://github.com/yuelangmanle/wenwenlex/releases)
- 当前正式版本页面：[v1.9](https://github.com/yuelangmanle/wenwenlex/releases/tag/v1.9)
- 当前开发目标版本：`v2.0`
...
- 当前 `1.9` 能力已完成代码与文档收口，等待 GitHub `Android Release` 云端工作流产出正式 Release 资产
...
- `2.0` 主线：真正的本地离线语音推理包、更完整的在线词典音频源，以及 scaffold pack 到真实模型资产的切换
- `2.0` 候选：学习数据图表和 HTML 可视化面板
- `2.0` 候选：AI 计划历史回溯、计划对比和解释性增强
- `2.0` 候选：导入表格纠错和字段补全过程进一步自动化
- `2.0` 候选：词条质量修订工具和词库增量更新流程
